...
\setbeamercolor{block title}{fg=fog, bg=sea}
...
\setbeamercolor{section in toc}{fg=lightgreen}
\setbeamercolor{subsection in toc}{fg=darkgreen}
\setbeamercolor{subsubsection in toc}{fg=stonecoal}
\setbeamercolor{bibliography item}{fg=lightgreen}
\setbeamercolor{bibliography entry author}{fg=lightgreen}
\setbeamercolor{bibliography entry title}{fg=sea}
\setbeamercolor{bibliography entry location}{fg=stonecoal}
\setbeamercolor{bibliography entry note}{fg=stonecoal}
...
% remove those ugly beamer bibliography icons
